...
export function Inicio() {
  ...
  const kicker = totalConcluidas === 0 ? "Comece por aqui" : "Continue assistindo";
  const acao =
    totalConcluidas === 0 ? "Começar a primeira aula" : "Continuar de onde parei";
        ...
        <section className="mt-1">
          ...
          <div className="flex flex-col gap-1 px-[2px] pt-3">
            ...
            <p className="m-0 text-[13px] text-white/55">
              ...
              {concluida(retomada.aula.id) ? "Aula concluída" : "Disponível agora"}
            </p>
          </div>
          ...
          <div className="flex w-full flex-wrap justify-center gap-[10px] pt-3 cel:flex-col">
            <button
              onClick={() =>
                navegar(`/aula/${retomada.modulo.numero}/${retomada.aula.ordem}`)
              }
          ...
          <div className="flex gap-[10px] cel:hidden">
            {[
              ...
              <button
                key={seta.rotulo}
                onClick={() =>
                  fileira.current?.scrollBy({ left: seta.passo, behavior: "smooth" })
                }
            ...
            >
              ...
              <span className="flex flex-col gap-2">
                <span className="flex justify-between text-[15px] text-[#9a9287]">
                  ...
                  <span style={{ color: e.destaque }}>{rotuloConcluidas(e.concluidas)}</span>
                </span>
                <Barra
